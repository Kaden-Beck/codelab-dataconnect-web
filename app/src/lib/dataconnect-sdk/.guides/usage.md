...
```js
import { upsertUser, addFavoritedMovie, deleteFavoritedMovie, addReview, deleteReview, listMovies, getMovieById, getActorById, getCurrentUser, getIfFavoritedMovie } from '@movie/dataconnect';
