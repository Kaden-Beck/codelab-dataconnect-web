...
- [**Queries**](#queries)
  ...
  - [*SearchAll*](#searchall)
  - [*SearchMovieDescriptionUsingL2similarity*](#searchmoviedescriptionusingl2similarity)
- [**Mutations**](#mutations)
...
interface SearchMovieDescriptionUsingL2similarityRef {
  ...
  /* Allow users to create refs without passing in DataConnect */
  (vars: SearchMovieDescriptionUsingL2similarityVariables): QueryRef<SearchMovieDescriptionUsingL2similarityData, SearchMovieDescriptionUsingL2similarityVariables>;
}
export const searchMovieDescriptionUsingL2similarityRef: SearchMovieDescriptionUsingL2similarityRef;
```
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
...
interface SearchMovieDescriptionUsingL2similarityRef {
  ...
  (dc: DataConnect, vars: SearchMovieDescriptionUsingL2similarityVariables): QueryRef<SearchMovieDescriptionUsingL2similarityData, SearchMovieDescriptionUsingL2similarityVariables>;
}
export const searchMovieDescriptionUsingL2similarityRef: SearchMovieDescriptionUsingL2similarityRef;
```

If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the searchMovieDescriptionUsingL2similarityRef:
```typescript
const name = searchMovieDescriptionUsingL2similarityRef.operationName;
console.log(name);
```
...
// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await searchMovieDescriptionUsingL2similarity(dataConnect, searchMovieDescriptionUsingL2similarityVars);
...
// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = searchMovieDescriptionUsingL2similarityRef(dataConnect, searchMovieDescriptionUsingL2similarityVars);
