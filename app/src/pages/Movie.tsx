          ...
          {auth.currentUser ? (
            <div className="mt-4 space-y-3">
              ...
              <Button variant="secondary" className="w-full gap-2" asChild>
                <Link
                  to={`/theatres?title=${encodeURIComponent(
                    movie.title
                  )}&tags=${encodeURIComponent(movie.tags?.join(","))}`}
                >
                  <MapPin className="w-4 h-4" /> Find in Theatres
                </Link>
              </Button>
            </div>
          ) : (
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 mt-4 text-muted-foreground">
              ...
              <span className="flex items-center gap-1 text-sm">
                <Clock className="w-4 h-4" /> {movie.genre}
              </span>
